...
namespace SimpleModelsAndRelations.Controllers
{
    ...
    public partial class ZooController : Controller
    {
        ...
        //GetAllAnimals implements a HTTP-GET method
        //TODO 4: [0.5pt]
        [...("GetAllAnimals")]
                                            //a specie is given as an input in the shape of a query parameter
                                            //TODO 5: [0.5pt]
        public IActionResult GetAllAnimals(... specie)
        {
            ...
            if (specie != "")
            {
                //when a specie is provided we need to adjust the query to retrieve the animals
                //TODO 6: [1.5pt]                
                ...
            }
